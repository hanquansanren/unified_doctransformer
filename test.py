...
if __name__ == '__main__':
    ...
    parser.set_defaults(resume='/Public/FMP_temp/fmp23_weiguang_zhang/DDCP2/flat/2022-11-13/2022-11-13 19:23:45 @2022-11-10/150/2022-11-10@2022-11-13 19:23:45DDCP.pkl')
    
    # 'dataset/testset/mytest0' 'dataset/testset/dissertation'
    parser.add_argument('--data_path_test', default=ROOT / 'dataset/testset/dissertation', type=str, help='the path of test images.')
