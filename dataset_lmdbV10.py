...
2022/11/4
Weiguang Zhang
V9 means polar-doc + old dataset
'''
import os
import pickle
...
class PerturbedDatastsForFiducialPoints_pickle_color_v2_v2(data.Dataset):
	def __init__(self, root, mode='1-1', img_shrink=None, is_return_img_name=False, preproccess=False, bfreq=None,hpf= None):
	...
	def __getitem__(self, item):
		if self.split == 'test':
			...
			lbl = self.fiducal_points_lbl(lbl)
